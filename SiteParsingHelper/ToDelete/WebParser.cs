...
//        //TryTo
//        //Add work units container - > get by key, add etc
//        // Add to workUnit - execute itself - Parse&SelectNext
//        // everything other in webparser - like path & first unit start point
